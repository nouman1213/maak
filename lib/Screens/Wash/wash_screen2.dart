...
import 'package:maak_prject/Screens/Road/raodServiceDetailScreen.dart';
...
class WashScreen2 extends StatefulWidget {
  WashScreen2({Key? key, required this.tabBarScreenModel}) : super(key: key);
  List<TabBarScreenModel>? tabBarScreenModel;

  @override
  State<WashScreen2> createState() => _WashScreen2State();
}
                      ...
                      child: ScrollConfiguration(
                        ...
                        child: GlowingOverscrollIndicator(
                          ...
                          child: ListView.builder(
                            itemCount: widget.tabBarScreenModel!.length,
