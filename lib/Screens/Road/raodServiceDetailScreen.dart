...
import 'package:maak_prject/Screens/Road/road_payementoption.dart';
...
class RoadServiceDetailScreen extends StatefulWidget {
  RoadServiceDetailScreen({Key? key}) : super(key: key);

  @override
  State<RoadServiceDetailScreen> createState() =>
      _RoadServiceDetailScreenState();
}
...
class _RoadServiceDetailScreenState extends State<RoadServiceDetailScreen> {
  @override
                                    ...
                                    child: Column(
                                      children: [
                                        TabBar(
                                            ...
                                            indicatorColor: kPrimaryGrey,
                                            tabs: [
                                              Tab(text: 'TOWING'),
                                              Tab(text: 'TIRE REPAIR'),
                                              Tab(
                                                  text:
                                                      'CAR DOOR LOCK OPEN OR FIX'),
                                              Tab(text: 'TIRE CHANGE'),
                                              Tab(text: 'BATTERY REPLACE'),
                                              Tab(
                                                  text:
                                                      'ELECTRICAL  CHECKUP AND FIX'),
                                              Tab(
                                                  text:
                                                      'CHANGE FILTER AND OIL'),
                                              Tab(text: 'AIR CONDITION FILL'),
                                            ]),
                                        Expanded(
                                            child: TabBarView(
                                          children: [
